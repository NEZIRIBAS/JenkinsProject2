...
public WebDriver driver;
	...
	public void verifyRegisterWithNoDetails() {
		...
		String expectedEmailWarningMessage = "Email adress does not appear to be valid!";
...
public void verifyRegisterwithMandatoryDetails() {
	   ...
	   driver.findElement(By.cssSelector("input#input-telephone")).sendKeys("987676543210");
...
@Test(priority=3)
public void verifyRegisterwithExistingEmail1() {
	   driver.findElement(By.cssSelector("input#input-firstname")).sendKeys("Selenium");
	   driver.findElement(By.cssSelector("input#input-lastname")).sendKeys("Panda");
	   driver.findElement(By.cssSelector("input#input-email")).sendKeys("seleniumpanda112@gmail.com");
	   driver.findElement(By.cssSelector("input#input-telephone")).sendKeys("987676543210");
...
@Test(priority=3)
public void verifyRegisterwithWrongConfrimPassword() {
